...
public class WordAcknowledge extends Activity {
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TextView textView=(TextView)findViewById(R.id.wordAcknowledgment);
        setTitle("Acknowledgements");
        String str="Idea"+'\n'+"1. Hello Android Book ";
        str+="\n2. Class Discussion regarding the Assignment  ";
        ...
        str+="\n\n";
        str+="\n Lastly special thanks to Amit Raul for discussion regarding project and its strategies";
